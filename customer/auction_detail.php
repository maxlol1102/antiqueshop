...
$sql = "SELECT * FROM auction WHERE id = '$id_auction'";
...
if($result == false){
	...
	if(mysqli_num_rows($result) == 0){
		die("No auction have id: $id_auction");
	}
...
<body>
		...
		<!-- Duong dan -->
		<div id ="duongdan">
			<p><a href="home.php">Home</a>/<a href="auction.php">Auction</a>/ <?php echo $title;  ?></p>
		</div>
		<br>
		...
		<div id="content">
			...
			<table id='tbcontent' class='table '>
				<tr>
					<td>
						<p style="font-size:48px; font-weight: bold;"><?php echo $title; ?></p>
						<br>
						<p style="font-size:26px; font-family: monospace; color:grey;">Location: <?php echo $location; ?></p>
						<p style="font-size:26px; font-family: monospace; color:grey;">Date and time: <?php echo $time; ?></p>
						<p style="font-size:26px; font-family: monospace; color:grey;">Require/Detail Infomation about the Auction: 
							<?php
						...
						<p style="font-size:26px; font-family: monospace; color:grey;"> 
							Status:
							<?php if(($status)==0){
								echo "Coming-soon!";
							}else if(($status)>0){
