...
<body>
		...
		<div class="topnav">
			...
			<a href="antique.php" style="margin-left: 50px;margin-right: 50px;">Antique</a>
		  	<a class="active grey" href="auction.php" style="margin-left: 30px;margin-right: 50px;">Auction</a>
		...
		<div id="content">
			<div style="height: 250px; background-color: #343A40;color: white; ">
				<h2 style="font-size: 53px; text-align: center; padding-top: 93px;">Auctions</h2>
			</div>
			<hr>
			...
			<?php 
				...
				if($result == false){
					...
					if(mysqli_num_rows($result) == 0){
						...
						$count = 0;
						echo "<div style='padding-left:200px; padding-right:50px;'>";
							echo "<table>";
								while($count != $total){
								$max = 0;
								echo "<tr>";
									while($row =mysqli_fetch_assoc($result)){
										$count ++;
										// Trong mỗi tr -> chi tiết 1 sản phẩm
											$id_auction = $row['id'];
											echo "<strong><a href='auction_detail.php?id=$id_auction'>"."Title: ".$row['title']."</a></strong><br>";
											echo "<br>";
											echo "<p>"."Location: ".$row['location']."</p>";
											echo "<p>"."Date and Time: ".$row['time']."</p>";
											echo "<p>"."Infomation: ".$row['description']."</p>";
