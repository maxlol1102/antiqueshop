...
<body>
		...
		<!-- SEARCH -->
		<div class="topnav">
		  <a class="active grey" href="home.php">Home</a>
		  <a href="antique.php" style="margin-left: 50px;margin-right: 50px;">Antique</a>
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="https://wallpaperaccess.com/full/2629487.jpg"class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="500" focusable="false" role="img" >
				</div>
				
				<div class="carousel-item">
					<img src="https://images.unsplash.com/photo-1497942304796-b8bc2cc898f3?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8dmludGFnZSUyMGFlc3RoZXRpY3xlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&w=1000&q=80"class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="500" focusable="false" role="img" >
				</div>

				<div class="carousel-item">
					<img src="https://wallpaperaccess.com/full/192242.jpg"class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="500" focusable="false" role="img" >
				</div>
			</div>
		...
		<!-- CONTENT -->		
		<div id="content">
			<h2 style="text-align: center; padding-top: 15px">Featured Products</h2>
			<hr>
