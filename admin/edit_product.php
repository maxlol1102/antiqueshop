...
if($result== false){
	...
	if(mysqli_num_rows($result)==0){
		die("<h3> There is no Product have ID $id_product</h3>");
	}
	else{
...
if(isset($_POST['btnInsert'])){
	...
	$sql = "UPDATE products SET name = '$name', price = '$price', image='$image', description = '$description', status ='$status' WHERE id = '$id_product'";
...
<body>
	<div class="container">
		...
		<div id="menu">
			...
			<a class="nav-link menuItem" href="home_type.php">Manage Types</a>
		...
		<!-- Phan Content -->
		<div id="content">
			<h2 style="text-align: center; font-family: 'News time Roman';">Update Infomation for this Product!</h2>
